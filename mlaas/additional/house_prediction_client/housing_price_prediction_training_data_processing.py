...
training_data_processing_config={'raw_file_paths':{'1':'/ml_worker/storage/house_prediction/train.csv'},
          'processed_data_file_path':'/ml_worker/storage/house_prediction/train_processed.csv',
          'data_processing_object_list':
              [{'data_process_id':'1',
               'data_process_shortname':'House Price Predictions Training Data Processing',
               ...
               'additional_params':
                    {'features':['MSSubClass','MSZoning','LotArea','LotShape','OverallQual','OverallCond','YearBuilt','YearRemodAdd','MasVnrArea','BsmtFinSF1','1stFlrSF','2ndFlrSF','GrLivArea','BsmtFullBath','FullBath','HalfBath','Functional','Fireplaces','GarageCars','WoodDeckSF','ScreenPorch','GarageYrBlt_na','LotFrontage'],
                     ...
                     'catvars':['MSZoning','LotShape','Functional'],
                     'catvarspredictor':
                         ['MSZoning','LotShape','Functional','SalePrice'],
                     'temporalvars':['YearBuilt','YearRemodAdd'],
                     'temporalvarspredictor':['YearBuilt','YearRemodAdd','YrSold'],
                     'basevar':'YrSold',
                     'numvars':
                         ['MSSubClass','LotArea','OverallQual','OverallCond','MasVnrArea','BsmtFinSF1','1stFlrSF','2ndFlrSF','GrLivArea','BsmtFullBath','FullBath','HalfBath','Fireplaces','GarageCars','WoodDeckSF','ScreenPorch','LotFrontage'],
                     'extravar':'GarageYrBlt_na','extra_new_var':'GarageYrBlt','skewedvars':
