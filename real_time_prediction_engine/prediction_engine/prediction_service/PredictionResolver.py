...
import prediction_service.utils as utils
...
def resolve(data):
    ...
    try:
        dict_pred = {}
        implementation= utils.getValFromDict(prediction_service.constants.Constants.IMPLEMENTATION, data)
        payload = utils.getValFromDict(prediction_service.constants.Constants.PAYLOAD, data)
        pipelineFilename = utils.getValFromDict(prediction_service.constants.Constants.PIPELINE_FILE_NAME, data)
        requestArguments = utils.getValFromDict(prediction_service.constants.Constants.REQUEST_ARGUMENTS, data) if prediction_service.constants.Constants.REQUEST_ARGUMENTS in data  else None
